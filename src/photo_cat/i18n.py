...
TOOLTIPS_EN: dict[str, str] = {
    ...
    "Output band": "The band contamination is estimated in. Choose a built-in mission filter, custom for your own curve, or none to keep the catalogue band.",
    ...
    "Conversion method": "The spectral model used to convert flux between bands. blackbody is ready; phoenix and empirical need external data.",
...
TOOLTIPS_IT: dict[str, str] = {
    ...
    "Output band": "La banda in cui si stima la contaminazione. Scegli un filtro di missione integrato, custom per una curva tua, o nessuna per la banda del catalogo.",
    ...
    "Conversion method": "Il modello spettrale usato per convertire il flusso tra bande. blackbody e' pronto; phoenix ed empirical richiedono dati esterni.",
